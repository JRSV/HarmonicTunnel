...
;; paths depending on the PC using

(defparameter *platform* 'imac) ;;; change to linux, macbook, imac

(set-sc-config 'default-dir "/Users/admin/odrive/WORK-Big/Pons-Percussion/scores/HT/")
...
(let* ((icv '(2 1 2 2 2 1))
  ...
  (push initial-pit music)
	...
	(setf base-path "/home/jrsv/Dropbox/Pons-Percussion/scores/HT");;linux
      (if (equal *platform* 'macbook) 
	  (setf base-path "");;macbook
	  (setf base-path "/Users/admin/odrive/WORK-Big/Pons-Percussion/scores/HT");;IMAC
  ...
  ;; (midi-play music :midi-file "/Users/admin/odrive/WORK-Big/Pons-Percussion/scores/HT/HarmTunel.mid")
